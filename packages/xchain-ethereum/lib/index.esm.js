...
import { baseAmount, assetToString, AssetETH, assetFromString, ETHChain, assetToBase, assetAmount, delay } from '@xchainjs/xchain-util';
...
var getAddress = function (baseUrl, address, apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios.get(baseUrl + "/getAddressInfo/" + address, {
                        params: {
...
var getTxInfo = function (baseUrl, hash, apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios.get(baseUrl + "/getTxInfo/" + hash, {
                        params: {
                            apiKey: apiKey || 'freekey',
                        },
                    })];
...
var getTxFromTokenTransaction = function (tx) {
    ...
    if (validateSymbol(symbol) && validateAddress(address)) {
        var tokenAsset = assetFromString(ETHChain + "." + symbol + "-" + address);
        if (tokenAsset) {
            return {
                asset: tokenAsset,
                from: [
...
var getTokenBalances = function (tokenBalances) {
    return tokenBalances.reduce(function (acc, cur) {
        ...
        if (validateSymbol(symbol) && validateAddress(tokenAddress) && ((_a = cur === null || cur === void 0 ? void 0 : cur.tokenInfo) === null || _a === void 0 ? void 0 : _a.decimals) !== undefined) {
            ...
            var tokenAsset = assetFromString(ETHChain + "." + symbol + "-" + ethers.utils.getAddress(tokenAddress));
            if (tokenAsset) {
...
var getGasOracle = function (baseUrl, apiKey) {
    ...
    return axios.get(url + getApiKeyQueryParameter(apiKey)).then(function (response) { return response.data.result; });
};
/**
 * Get token balance
 *
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.get(url).then(function (response) { return response.data.result; })];
                case 2:
                    result = _b.sent();
...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        ...
        this.purgeClient = function () {
            _this.hdNode = HDNode.fromMnemonic('');
        };
        /**
        ...
        this.getWallet = function (index) {
            if (index === void 0) { index = 0; }
            return new Wallet(_this.hdNode.derivePath(_this.getFullDerivationPath(index))).connect(_this.getProvider());
        };
        this.setupProviders = function () {
            if (_this.infuraCreds) {
                ...
                var testnetProvider = _this.infuraCreds.projectSecret
                    ? new ethers.providers.InfuraProvider(Network.TEST, _this.infuraCreds)
                    : new ethers.providers.InfuraProvider(Network.TEST, _this.infuraCreds.projectId);
                var mainnetProvider = _this.infuraCreds.projectSecret
                    ? new ethers.providers.InfuraProvider(Network.MAIN, _this.infuraCreds)
                    : new ethers.providers.InfuraProvider(Network.MAIN, _this.infuraCreds.projectId);
                _this.providers.set('testnet', testnetProvider);
                _this.providers.set('mainnet', mainnetProvider);
            }
            else {
                _this.providers.set('testnet', getDefaultProvider(Network.TEST));
                _this.providers.set('mainnet', getDefaultProvider(Network.MAIN));
            }
        };
        /**
        ...
        this.getProvider = function () {
            ...
            return _this.providers.get(net) || getDefaultProvider(net);
        };
        /**
        ...
        this.getEtherscanProvider = function () {
            return new EtherscanProvider(_this.network, _this.etherscanApiKey);
        };
        /**
        ...
        this.setPhrase = function (phrase, walletIndex) {
            ...
            _this.hdNode = HDNode.fromMnemonic(phrase);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (!(assetToString(asset) !== assetToString(AssetETH))) return [3 /*break*/, 7];
                        assetAddress = getTokenAddress(asset);
                        if (!assetAddress) {
        ...
        params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                contract = new ethers.Contract(contractAddress, abi, this.getProvider()).connect(this.getWallet(0));
...
export { Client, ETHAddress, ETH_DECIMAL, Network, estimateDefaultFeesWithGasPricesAndLimits, getDecimal, getDefaultFees, getFee, getPrefix, getTokenAddress, validateAddress };
