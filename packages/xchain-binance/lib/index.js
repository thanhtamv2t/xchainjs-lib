...
var parseTx = function (tx) {
    var asset = xchainUtil.assetFromString(xchainUtil.AssetBNB.chain + "." + tx.txAsset);
    if (!asset)
        return null;
    return {
        asset: asset,
...
var getDefaultFees = function () {
    var singleTxFee = xchainUtil.baseAmount(37500);
    return {
        type: 'base',
        fast: singleTxFee,
        fastest: singleTxFee,
...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        ...
        this.getPrivateKey = function (index) {
            ...
            return crypto.getPrivateKeyFromMnemonic(_this.phrase, true, index);
        };
        /**
        ...
        this.getAddress = function (index) {
            if (index === void 0) { index = 0; }
            return crypto.getAddressFromPrivateKey(_this.getPrivateKey(index), getPrefix(_this.network));
        };
        /**
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, balances
                                ...
                                return {
                                    asset: xchainUtil.assetFromString(xchainUtil.BNBChain + "." + balance.symbol) || xchainUtil.AssetBNB,
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            _b.sent();
                            return [4 /*yield*/, this.bncClient.transfer(this.getAddress(), recipient, xchainUtil.baseToAsset(amount).amount().toString(), asset ? asset.symbol : xchainUtil.AssetBNB.symbol, memo)];
                        case 3:
        ...
        this.getMultiSendFees = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        transferFee = _a.sent();
                        multiTxFee = xchainUtil.baseAmount(transferFee.multi_transfer_fee);
                        return [2 /*return*/, {
                                type: 'base',
                                average: multiTxFee,
                                fast: multiTxFee,
